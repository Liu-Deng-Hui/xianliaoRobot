...
public class MyMqttService extends Service {
    ...
    private void init() {
        ...
        //CLIENTID
        mqttAndroidClient = new MqttAndroidClient(this, serverURI,System.currentTimeMillis()+"");
    ...
    @Download.onTaskComplete void taskComplete(DownloadTask task) {
        ...
        if(oleImgTitle!=null){
            if(!oleImgTitle.equals(data.getTitle())){
                deleteSingleFile(Environment.getExternalStorageDirectory() + "/DCIM/100ANDRO/"+oleImgTitle);
            }
        }
